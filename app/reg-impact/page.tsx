...
export default function RegImpactPage() {
  ...
  const loadSampleData = async () => {
    ...
    try {
      const sampleText = "Basel III requires higher capital ratios for trading activities and derivatives exposure."
      const sampleResults = {
      ...
      if (response.ok) {
        ...
        if (data.success && data.data) {
          setResults(data.data)
          setRegulatoryText(data.sampleText || sampleText)
        } else {
          setResults(sampleResults)
          setRegulatoryText(sampleText)
        }
      } else {
        setResults(sampleResults)
        setRegulatoryText(sampleText)
